...
def get_pdf(k):
    ...
    output_pdf.close()
    webbrowser.open_new(r'/home/ortfs/Desktop/rb_parser/v5/' + title + ' .pdf')
...
def matchtostring(list):
    outstring = ""
    if list == []:
        out = "No standard found! Make sure you capitalize your keyword Like This!"
    else:
        for i in range(len(list)):
            string = list[i][0] + "     " + str(list[i][1]) + " "
            string += "\n" + " "
            outstring += string
